var namesDataBase = "NetScape 1991 Carpenter Brut Miami Hollywood Windows Macintosh Cyber Razor 1984 Heat Summer Sony Silverhand Noir City Infiltrator Mega Dropzone Defender Neon L.A. Angel MadMax Stereo Roland 808 Buck Power Gloves Nintendo Turbo Nitro Thunder FM Cassette Night Stud Velvet Future Techno DX Transistor Cell Surrender Prophet Fairlight Jupiter Electro Venus Throttle Ferrarri Lamborghini Testarossa Cruise Atari Panther Viper Cobra Cycle Boulevard Metropolis Ninja Lipstick 2049 Violator Robotron Body Leotard Rouge BladeRunner Eyeshadow Filter Arpeggiator Lowpass Handheld 2077 VCR Betamax LP Burner Colecovision 2600 Omnicorp Madame Tech System Cyberdyne Bosch Trevor Tiffany Kylie Asteroid Polybius Odyssey Lazer Photon Tyrell Vinyl Arnold Magnum";
...
function generateName() {
    ...
    var listLength = (nameList.length) - 1;
    ...
    for (var count = 0; count < nameLength; count++) {
        ...
        PowerName.push(nameList[wordIndex]);
    }
